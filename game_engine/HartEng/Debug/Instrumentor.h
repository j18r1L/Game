...
namespace HE
{
    ...
    #endif
    #define HE_PROFILE_BEGIN_SESSION(name, filepath)    ::HE::Instrumentor::Get().BeginSession(name, filepath)
    #define HE_PROFILE_END_SESSION()                    ::HE::Instrumentor::Get().EndSession()
