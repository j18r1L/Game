...
namespace HE
{
	...
	uint32_t OpenGLShaderUniformDeclaration::SizeOfUniformType(Type type)
	{
		...
		HE_CORE_ERROR("Invalid OpenGLShaderUniformDeclaration::SizeOfUniformType Type!");
		return 0;
	}
	...
	OpenGLShaderUniformDeclaration::Type OpenGLShaderUniformDeclaration::StringToType(const std::string& type)
	{
		...
		//HE_CORE_ERROR("Invalid OpenGLShaderUniformDeclaration::StringToType Type!");
		return Type::NONE;
	}
	...
	std::string OpenGLShaderUniformDeclaration::TypeToString(Type type)
	{
		...
		HE_CORE_ERROR("Invalid OpenGLShaderUniformDeclaration::TypeToString Type!");
		return "Invalid Type";
	}
	...
	OpenGLShaderResourceDeclaration::Type OpenGLShaderResourceDeclaration::StringToType(const std::string& type)
	{
		...
		HE_CORE_ERROR("Invalid OpenGLShaderResourceDeclaration::StringToType Type!");
		return Type::NONE;
	}
	...
	std::string OpenGLShaderResourceDeclaration::TypeToString(Type type)
	{
		...
		HE_CORE_ERROR("Invalid OpenGLShaderResourceDeclaration::TypeToString Type!");
		return "Invalid Type";
	}
}