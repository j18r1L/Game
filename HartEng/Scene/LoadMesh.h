...
namespace HE
{
    ...
    {
    private:
        static void ProcessNode(Entity* entity, aiNode *node, const aiScene *scene, const std::string& directory);
    ...
    public:
        static void CreateMesh(Entity* entity, const std::string& filePath);
    };
}
